 ...
 */
public final class DiscoveryNodeRole {
    ...
    private DiscoveryNodeRole(final String roleName, final String roleNameAbbreviation) {
     ...
     */
    public static Set<DiscoveryNodeRole> ROLES = Set.of(DATA_ROLE, MASTER_ROLE);
